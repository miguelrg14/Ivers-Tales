...
public class FinalBossL3 : FinalBoss
{
    [Group("References")]
    [SerializeField]
    ...
    private void Awake()
    {
        ...
        oneLogic = GetComponent<StateOneLogicBossL3>();
        ...
        bossHSM.AddState(BossState.State1, new StateOneBossL3(true, player, this, oneLogic));
