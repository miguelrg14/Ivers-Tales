...
{
    [SerializeField] AudioMixer general_mixer;
    [SerializeField] AudioMixer music_mixer;
    [SerializeField] AudioMixer sfx_mixer;
    [SerializeField] AudioMixer ambient_mixer;
    [SerializeField] AudioMixer dialogues_mixer;
    ...
    [SerializeField] float defaultUiVolume = 1f;
    [SerializeField] float defaultVoiceVolume = 1f;
    ...
    public void SetGeneralVolume(float volume)
    {
        ...
        general_mixer.SetFloat("masterVolume", Mathf.Log10(volume) * 20);
    ...
    public void SetMusicVolume(float volume)
    {
        ...
        general_mixer.SetFloat("musicVolume", Mathf.Log10(volume) * 20);
    ...
    public void SetSfxVolume(float volume)
    {
        ...
        general_mixer.SetFloat("sfxVolume", Mathf.Log10(volume) * 20);
    ...
    public void SetUiVolume(float volume)
    {
        ...
        general_mixer.SetFloat("uiVolume", Mathf.Log10(volume) * 20);
    ...
    public void SetDialogueVolume(float volume)
    {
        ...
        general_mixer.SetFloat("voiceVolume", Mathf.Log10(volume) * 20);
    ...
    public void Reset_AudioOptions()
    {
        ...
        general_mixer.SetFloat("masterVolume", Mathf.Log10(defaultMasterVolume) * 20);
        PlayerPrefs.SetFloat("masterVolume", defaultMasterVolume);

        musicVolumeSlider.value = defaultMusicVolume;
        //audioMixer.SetFloat("musicVolume", defaultMusicVolume);
        general_mixer.SetFloat("musicVolume", Mathf.Log10(defaultMusicVolume) * 20);
        ...
        general_mixer.SetFloat("sfxVolume", Mathf.Log10(defaultSfxVolume) * 20);
        ...
        general_mixer.SetFloat("uiVolume", Mathf.Log10(defaultUiVolume) * 20);
        ...
        general_mixer.SetFloat("voiceVolume", Mathf.Log10(defaultVoiceVolume) * 20);
